...
{
header("Content-Disposition: attachment; filename=Lembar-Pendapatan-Voucher-$tanggal1.xls");
}
else
{
header("Content-Disposition: attachment; filename=Lembar-Pendapatan-Voucher-$tanggal1-$tanggal2.xls");    
}
?>
<html>
