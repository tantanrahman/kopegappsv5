...
<?php 
    ...
    echo "<center><h4>Laporan Pengawasan Tanggal $tanggal1</h4></center><hr>";
        ...
        <table class="table table-bordered table-hover table-striped">
            <thead>
                <tr>
                    ...
                    <th colspan="2">Selisih Tanggal <?php echo "$tanggal1"; ?></th>
                    <th colspan="3">Pendapatan</th>
                    <th rowspan="3">Sisa Setoran</th>
                    <th rowspan="3"><?php echo "RK Tanggal $tampil ";?> </th>
                    <th colspan="2"><?php echo "Selisih Tanggal $tampil ";?> </th>
                    <th rowspan="4">SALDO BANK</th>
                </tr>
                <tr>
                    <th rowspan="2">Titpan</th>
                    <th rowspan="2">Talangan</th>
                    <th rowspan="2"><?php echo "$tanggal1"; ?></th>
                    <th rowspan=""><?php echo "$tampil"; ?></th>
                    <th rowspan="">Jumlah</th>
                    <th rowspan="2">Titpan</th>
                    <th rowspan="2">Talangan</th>
                </tr>
                <tr>
