...
<?php
    ...
    $sql3 = "SELECT lokasi.lokasi AS pdlokasi,lokasi.tempat AS tempat, pdam.tanggal AS pdtanggal, lokasi.loket AS pdloket, SUM(pdam.bill) AS pdbill, SUM(pdam.total_kopeg)-SUM(fee_pdam.`fee_mitra`) AS penpdam, SUM(fee_pdam.`fee_mitra`) AS feepdam FROM lokasi LEFT JOIN pdam ON lokasi.loket = pdam.loket AND 
