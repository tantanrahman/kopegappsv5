<?php
    ...
    if ($tanggal1 == $tanggal2) {
        header("Content-Disposition: attachment; filename=Lembar-Pendapatan-PDAM-$tanggal1.xls");
    } else {
        header("Content-Disposition: attachment; filename=Lembar-Pendapatan-PDAM-$tanggal1-$tanggal2.xls");	
    }
?>
