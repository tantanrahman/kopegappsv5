...
header("Content-Disposition: attachment; filename=Surat-Permohonan-Transfer-$tanggal1.xls");
...
<table >
	...
	<tr>
		<td colspan="2">Nomor : &nbsp;&nbsp;&nbsp;&nbsp;/DADALI/<?php echo "&nbsp;&nbsp;&nbsp;/$tahun"; ?></td>
        <td colspan="1"></td>
	</tr>
	<tr>
...
<table >
	...
	<tr>
        <td></td>
        <td colspan="4" align=center><i>Sebesar : Rp <?php echo "$tampil1"; ?></i></td>
    </tr>
	<tr>
        <td></td>
        <td colspan="4">Terbilang : <?php  echo "$terbilang1"; ?> Rupiah</td>
    </tr>
	<tr>
        <td></td>
    </tr>
	<tr>
		<th align="right">b.</th>
		<td width="125px"><b>Virtual Account </b></td><th colspan="1">: 988 000 271 069 528 3</th>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
        <td></td>
        <td colspan="4" align=center><i>Sebesar : Rp <?php echo "$tampil2";?></i></td>
    </tr>
	<tr>
        <td></td>
        <td colspan="4">Terbilang : <?php  echo "$terbilang2"; ?> Rupiah</td>
    </tr>
</table>
</table>
...
<table>
	...
	<tr>
		<td></td>
        <td colspan="4"> atas Transaksi KOPEGTEL DADALI 185</td>
	</tr>
	<tr>
        <td></td>
        <td colspan="4" align=center><i>Sebesar : Rp <?php echo "$tampil3";?></i></td>
    </tr>
	<tr>
        <td></td>
        <td colspan="4">Terbilang : <?php  echo "$terbilang3"; ?> Rupiah</td>
    </tr>
	<tr>
        <td></td>
    </tr>
