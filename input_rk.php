<div class="container-fluid mt-3">
    ...
    <h4 class="text-center">Input Rekening Koran Tanggal
        <?php 
    ...
    <div class="col-md-6 offset-md-3">
        <table class="table table-bordered table-hover">
            <tr>
                ...
                <th style="text-align:center;">USER/LOKER SOPP</th>	
                <th style="text-align:center;">REKENING KORAN</th>
            </tr>
        ...
        <?php
            ...
            echo "<td>$i</td><td>{$row['tempat']}</td><td><input type=text class='form-control' name='rk[]' value='{$row[jumlah_rk]}'><input type=hidden name='tanggalrk[]' value='$tampil_date.{$row['tempat']}'></td></tr>";
        $i++;
    ...
    <div class="col-md-6 offset-md-3">
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td><div><input type="text" class='form-control' name="titipantambahan" value="<?php echo "{$datatitipan[nominal]}"; ?>"></td>
            </tr>
            <tr>
                <td>Transfer Ke Finnet</td>
                <td><div><input type="text" class='form-control' name="finnet1" value="<?php echo "{$data[transfer1]}"; ?>"></td>
            </tr>
            <tr>
                <td>Transfer Ke Finnet</td>
                <td><div><input type="text" class='form-control' name="finnet2" value="<?php echo "{$data[transfer2]}"; ?>"></td>
            </tr>
            <tr>
                <td>Transfer Ke Arindo</td>
                <td><div><input type="text" class='form-control' name="finnet3" value="<?php echo "{$data[transfer3]}"; ?>"></td>
            </tr>
            <tr>
                <td>Transfer Ke Finnet</td>
                <td><div><input type="text" class='form-control' name="finnet4" value="<?php echo "{$data[transfer4]}"; ?>"></td>
            </tr>
            <tr>
                <td>Biaya</td>
                <td><div><input type="text" class='form-control' name="biaya" value="<?php echo "{$data[biaya]}"; ?>"></td>
            </tr>
            <tr>
                <td>Tarik Tunai</td>
                <td><div><input type="text" class='form-control' name="tarik_tunai" value="<?php echo "{$data[tarik_tunai]}"; ?>"></td>
            </tr>
            <tr>
                <td>Jasa Giro</td>
                <td><div><input type="text" class='form-control' name="jasa_giro" value="<?php echo "{$data['jasa giro']}"; ?>"></td>
            </tr>
            <tr>
                <td>PPH</td>
                <td><div><input type="text" class='form-control' name="pph" value="<?php echo "{$data[pph]}"; ?>"></td>
            </tr>
            <tr>
                <td>Kel Giro</td>
                <td><div><input type="text" class='form-control' name="kel_giro" value="<?php echo "{$data['kel giro']}"; ?>"></td>
            </tr>
        </table>
    </div>
</div>
	<center>
		<input type="submit" value="Simpan" class="btn btn-primary mt-3 mb-3">
	</center>
</form>
</div>