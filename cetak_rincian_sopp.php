...
{
header("Content-Disposition: attachment; filename=Rincian-SOPP-$tanggal1.xls");
}
else
{
header("Content-Disposition: attachment; filename=Rincian-SOPP-$tanggal1-$tanggal2.xls");    
}
?>
    <html lang="en">
...
$tampildatabayar7 = number_format(ceil($ppn*0.1), $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan);
            ...
            <tr><td height="125px"></td></tr>
            <tr><td colspan="5"></td><td>Bandung, ....................</td></tr>
