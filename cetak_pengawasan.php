...
header("Content-Disposition: attachment; filename=Laporan-Pengawasan-$tanggal1.xls");
...
?>
<table id="mytable" class="table table-bordered table-striped table-fixed-header" border="1">
                    <thead class="header">
	<tr>
		<th rowspan="4">No</th>
