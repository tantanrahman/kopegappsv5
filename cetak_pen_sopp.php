...
<?php
    ...
    if ($tanggal1 == $tanggal2) {
        header("Content-Disposition: attachment; filename=Lembar-Pendapatan-SOPP-$tanggal1.xls");
    } else {
        header("Content-Disposition: attachment; filename=Lembar-Pendapatan-SOPP-$tanggal1-$tanggal2.xls");    
    }
?>
